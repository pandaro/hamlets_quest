...
local CHANCE_A = 7000
local CHANCE_B = 9000
local ACTIVE_OBJECT_COUNT = 2

mobs_goblins:spawn_specific("mobs_goblins:goblin_cobble",
   {"group:stone"}, "air", MIN_LIGHT, MAX_LIGHT, INTERVAL, CHANCE_A,
   ACTIVE_OBJECT_COUNT, gCob_min , gCob_max)

mobs_goblins:spawn_specific("mobs_goblins:goblin_digger",
   {"group:stone"},  "air", MIN_LIGHT, MAX_LIGHT, INTERVAL, CHANCE_A,
   ACTIVE_OBJECT_COUNT, gDig_min , gDig_max)

mobs_goblins:spawn_specific("mobs_goblins:goblin_coal",
   {"default:stone_with_coal", "default:mossycobble"}, "air",
   MIN_LIGHT, MAX_LIGHT, INTERVAL, CHANCE_B, ACTIVE_OBJECT_COUNT,
   gCoa_min, gCoa_max)

mobs_goblins:spawn_specific("mobs_goblins:goblin_iron",
   {"default:stone_with_iron", "default:mossycobble"}, "air",
   MIN_LIGHT, MAX_LIGHT, INTERVAL, CHANCE_B, ACTIVE_OBJECT_COUNT,
   gIro_min, gIro_max)

mobs_goblins:spawn_specific("mobs_goblins:goblin_copper",
   {"default:stone_with_copper", "default:mossycobble"}, "air",
   MIN_LIGHT, MAX_LIGHT, INTERVAL, CHANCE_B, ACTIVE_OBJECT_COUNT,
   gCop_min, gCop_max)

mobs_goblins:spawn_specific("mobs_goblins:goblin_gold",
   {"default:stone_with_gold", "default:mossycobble"}, "air",
   MIN_LIGHT, MAX_LIGHT, INTERVAL, CHANCE_B, ACTIVE_OBJECT_COUNT,
   gGol_min, gGol_max)

mobs_goblins:spawn_specific("mobs_goblins:goblin_diamond",
   {"default:stone_with_diamond", "default:mossycobble"}, "air",
   MIN_LIGHT, MAX_LIGHT, INTERVAL, CHANCE_B, ACTIVE_OBJECT_COUNT,
   gDia_min, gDia_max)

mobs_goblins:spawn_specific("mobs_goblins:goblin_king",
   {"default:mossycobble"}, "air", MIN_LIGHT, MAX_LIGHT, INTERVAL,
   CHANCE_B, ACTIVE_OBJECT_COUNT, gKin_min, gKin_max)

mobs_goblins:register_egg("mobs_goblins:goblin_cobble", "goblin egg",
